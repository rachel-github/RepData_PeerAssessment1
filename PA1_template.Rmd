...
The mean total steps per day is **`r round(mean.daily.steps, digits=0)`**.  
The median total steps per day is **`r round(median.daily.steps, digits=0)`**.

## What is the average daily activity pattern?

```{r, avedailypattern, echo=TRUE}
# Calculate the average steps (across all days) for each interval
mean.per.interval.steps <- tapply(data$steps, data$interval, 
